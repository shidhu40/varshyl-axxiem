...
<div id="tribe-events-content" class="tribe-events-month">
	...
	<div id="tribe-events-header" <?php tribe_events_the_header_attributes() ?>>
        <?php if (! empty( $_REQUEST['tribe-bar-date'] ) ) {
        $crd_date = $_REQUEST['tribe-bar-date'].'-01';
	    echo "<h3 class='current_display_date'>".date('F',strtotime($crd_date))."</h3>";
    } else { 
 		echo "<h3 class='current_display_date'>".date('F')."</h3>";
} ?>
		<!-- Header Navigation -->
