 ...
 */
$hide_event_date = get_post_meta(get_the_ID(), 'hide_event_date', true );
 if($hide_event_date ==1) {
	 return;
 }
...
<?php if ( $not_skeleton ) : ?>
	<div class="tribe-events-single-section tribe-events-event-meta primary tribe-clearfix aaaaaa">
<?php endif; ?>
