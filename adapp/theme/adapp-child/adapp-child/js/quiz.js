...
jQuiz = {
                currentQuestion: 1,
                correctAnswers: {1: 3, 2: 1, 3: 1, 4: 3, 5: 1, 6: 3},
                userAnswers: {},
                questionAnswers: {
                    1: {question: ' Tobacco use can be contributed to about ______________ deaths in the United States each year. ', options: ['50,000', '100,000', ' 440,000 ']},
                    2: {question: 'Smoking cigarettes changes ___________________________________.', options: ['The amount of a brain chemical that allows us to experience pleasure ', 'The amount of blood that flows to the brain ', 'The number of things we worry about ']},
                    3: {question: 'Cigarette smoke contains __________ chemicals. ', options: ['4,000', '1,000', '400']},
                    4: {question: 'Cigarette smokers are addicted to ____________.', options: ['Tar', 'Carbon Monoxide', 'Nicotine']},
                    5: {question: 'After a puff of a cigarette, nicotine is in the brain in _________ seconds. ', options: ['8', '18', '80']},
                    6: {question: 'In the brain, nicotine locks into receptors on neurons making the smoker feel __________. ', options: ['Irritable', 'Sleepy', 'Alert and Satisfied']}
                },
                firstQuestion: 1,
                lastQuestion: 6,
                init: function() {
                    ...
                    $(".btnNext").click(function() {
                        ...
                        jQuiz.currentQuestion = nextQuestionNumber;
                ...
                viewQuestion: function(questionNumber) {
                    ...
                    $("#last-question").html(this.lastQuestion);
