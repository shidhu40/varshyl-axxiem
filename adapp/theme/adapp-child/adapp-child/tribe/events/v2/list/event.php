 ...
 */
$axxi_class = 'axxi_no_login';
if (is_user_logged_in()) {	
	$axxi_class = '';
	if(current_user_can('staff')){
		$axxi_class = 'axxi_staff';
	}
	if(current_user_can('customer')){
		$axxi_class = 'axxi_customer';
	}
}
$container_classes = [ 'tribe-common-g-row', 'tribe-events-calendar-list__event-row' , $axxi_class];
